...
@Component({
  selector: 'app-youngest-players',
  templateUrl: './youngest-players.component.html',
  styleUrls: ['./youngest-players.component.scss'],
})
export class YoungestPlayersComponent implements OnInit {
